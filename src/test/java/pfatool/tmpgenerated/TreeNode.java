...
public class TreeNode extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5660139231795082831L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TreeNode\",\"namespace\":\"pfatool.tmpgenerated\",\"fields\":[{\"name\":\"field\",\"type\":{\"type\":\"enum\",\"name\":\"ColumnNames\",\"symbols\":[\"x0\",\"x1\",\"x2\",\"x3\"]}},{\"name\":\"operator\",\"type\":\"string\"},{\"name\":\"value\",\"type\":\"double\"},{\"name\":\"pass\",\"type\":[\"TreeNode\",\"double\"]},{\"name\":\"fail\",\"type\":[\"TreeNode\",\"double\"]}]}");
  ...
  public static TreeNode fromByteBuffer(
   ...
   private pfatool.tmpgenerated.ColumnNames field;
   ...
   */
  public TreeNode(pfatool.tmpgenerated.ColumnNames field, java.lang.CharSequence operator, java.lang.Double value, java.lang.Object pass, java.lang.Object fail) {
    this.field = field;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: field = (pfatool.tmpgenerated.ColumnNames)value$; break;
   ...
   */
  public pfatool.tmpgenerated.ColumnNames getField() {
    return field;
  }
   ...
   */
  public void setField(pfatool.tmpgenerated.ColumnNames value) {
    this.field = value;
  }
   ...
   */
  public static pfatool.tmpgenerated.TreeNode.Builder newBuilder() {
    return new pfatool.tmpgenerated.TreeNode.Builder();
  }
   ...
   * @return A new TreeNode RecordBuilder
   */
  public static pfatool.tmpgenerated.TreeNode.Builder newBuilder(pfatool.tmpgenerated.TreeNode.Builder other) {
    if (other == null) {
      return new pfatool.tmpgenerated.TreeNode.Builder();
    } else {
      return new pfatool.tmpgenerated.TreeNode.Builder(other);
    }
  }
   ...
   * @return A new TreeNode RecordBuilder
   */
  public static pfatool.tmpgenerated.TreeNode.Builder newBuilder(pfatool.tmpgenerated.TreeNode other) {
    if (other == null) {
      return new pfatool.tmpgenerated.TreeNode.Builder();
    } else {
      return new pfatool.tmpgenerated.TreeNode.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TreeNode>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(pfatool.tmpgenerated.TreeNode.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(pfatool.tmpgenerated.TreeNode other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.field)) {
        this.field = data().deepCopy(fields()[0].schema(), other.field);
    ...
    /**
      ...
      * @return This builder.
      */
    public pfatool.tmpgenerated.TreeNode.Builder setField(pfatool.tmpgenerated.ColumnNames value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pfatool.tmpgenerated.TreeNode.Builder clearField() {
      field = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public pfatool.tmpgenerated.TreeNode.Builder setOperator(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pfatool.tmpgenerated.TreeNode.Builder clearOperator() {
      operator = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public pfatool.tmpgenerated.TreeNode.Builder setValue(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pfatool.tmpgenerated.TreeNode.Builder clearValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public pfatool.tmpgenerated.TreeNode.Builder setPass(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pfatool.tmpgenerated.TreeNode.Builder clearPass() {
      pass = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public pfatool.tmpgenerated.TreeNode.Builder setFail(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pfatool.tmpgenerated.TreeNode.Builder clearFail() {
      fail = null;
    ...
    public TreeNode build() {
      try {
        ...
        record.field = fieldSetFlags()[0] ? this.field : (pfatool.tmpgenerated.ColumnNames) defaultValue(fields()[0]);
